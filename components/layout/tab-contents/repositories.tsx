...
export function RepositoriesContent({ repositories, error, username }: RepositoriesContentProps) {
  return (
      ...
      <div className="space-y-4">
        {error ? (
          <div className="text-center py-10 text-muted-foreground">
            <p>{error}</p>
            <p className="text-sm mt-2">Please check the username configuration.</p>
          </div>
            ...
            {username && (
              <div className="text-center pt-4">
                <Button variant="outline" asChild>
                  <Link href={`https://github.com/${username}?tab=repositories`} target="_blank" rel="noopener noreferrer">
